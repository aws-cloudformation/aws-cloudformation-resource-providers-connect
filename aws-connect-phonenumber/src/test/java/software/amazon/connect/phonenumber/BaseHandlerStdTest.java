...
import static software.amazon.connect.phonenumber.PhoneNumberTestDataProvider.VALID_TAG_KEY_ONE;
import static software.amazon.connect.phonenumber.PhoneNumberTestDataProvider.VALID_TAG_KEY_TWO;
import static software.amazon.connect.phonenumber.PhoneNumberTestDataProvider.VALID_TAG_VALUE_ONE;
import static software.amazon.connect.phonenumber.PhoneNumberTestDataProvider.VALID_TAG_VALUE_TWO;
...
public class BaseHandlerStdTest {
    ...
    public void testConvertResourceTagsToSet() {
        ...
        assertEquals(tagSet, BaseHandlerStd.convertResourceTagsToSet(tagMap));
    }
}
