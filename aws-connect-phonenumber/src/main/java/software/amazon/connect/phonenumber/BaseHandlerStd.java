...
public abstract class BaseHandlerStd extends BaseHandler<CallbackContext> {
    ...
    static final Constant STABILIZATION_DELAY = Constant.of()
    ...
    protected static void handleCommonExceptions(final Exception ex, final Logger logger) {
        ...
        } else if (ex instanceof ConnectException && StringUtils.equals(THROTTLING_ERROR_CODE,
                                                                        ((ConnectException) ex).awsErrorDetails().errorCode())) {
