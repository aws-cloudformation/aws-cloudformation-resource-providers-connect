...
import static software.amazon.connect.user.UserTestDataProvider.VALID_TAG_KEY_ONE;
import static software.amazon.connect.user.UserTestDataProvider.VALID_TAG_KEY_TWO;
import static software.amazon.connect.user.UserTestDataProvider.VALID_TAG_VALUE_ONE;
import static software.amazon.connect.user.UserTestDataProvider.VALID_TAG_VALUE_TWO;
