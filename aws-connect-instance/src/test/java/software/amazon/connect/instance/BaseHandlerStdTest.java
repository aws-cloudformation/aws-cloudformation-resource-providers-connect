...
public class BaseHandlerStdTest {
    ...
    private static final String PARAMETER_NAME = "Instance";
    ...
    private static final String INVALID_PARAMETER_FOR_INSTANCE_TYPE_SAML = "Invalid request provided: Invalid Parameter DIRECTORY_ID for type SAML";
    ...
    public void testRequireNullForType() {
        CfnInvalidRequestException cfnInvalidRequestException = assertThrows(CfnInvalidRequestException.class, () ->
                BaseHandlerStd.requireNullForType(Instance.builder().build(), DIRECTORY_ID, SAML));
        assertThat(INVALID_PARAMETER_FOR_INSTANCE_TYPE_SAML).isEqualTo(cfnInvalidRequestException.getMessage());
    }
}
