...
public class BaseHandlerStdTest {
    ...
    @Test
    public void testHandleCommonExceptions_PropertyValidationException_DuplicateResourceReason() {
        PropertyValidationExceptionProperty property =
                PropertyValidationExceptionProperty.builder()
                        .reason(PropertyValidationExceptionReason.RESOURCE_NAME_ALREADY_EXISTS)
                        .message("task template already exists")
                        .build();
        Exception ex = PropertyValidationException.builder().propertyList(Arrays.asList(property)).build();
        assertThrows(CfnAlreadyExistsException.class, () ->
                BaseHandlerStd.handleCommonExceptions(ex, logger));
    }

    @Test
    public void testHandleCommonExceptions_PropertyValidationException_RequiredPropertyMissingReason() {
        PropertyValidationExceptionProperty property =
                PropertyValidationExceptionProperty.builder()
                        .reason(PropertyValidationExceptionReason.REQUIRED_PROPERTY_MISSING)
                        .build();
        Exception ex = PropertyValidationException.builder().propertyList(Arrays.asList(property)).build();
    ...
    public void testConvertResourceTagsToSet() {
        String VALID_TAG_KEY_ONE = "TagKeyOne";
        String VALID_TAG_VALUE_ONE = "A";
        String VALID_TAG_KEY_TWO = "TagKeyTwo";
        String VALID_TAG_VALUE_TWO = "B";
