...
public class BaseHandlerStdTest {
    ...
    private static final String PARAMETER_NAME = "InstanceStorageConfig";
    ...
    private static final String INVALID_PARAMETER_FOR_RESOURCE_TYPE_CHAT_TRANSCRIPTS = "Invalid request provided: Invalid Parameter KINESIS_FIREHOSE for resource type CHAT_TRANSCRIPTS";
    private static final String INVALID_PARAMETER_FOR_STORAGE_TYPE_S3 = "Invalid request provided: Invalid Parameter KinesisVideoStreamConfig for storage type S3";
    ...
    @Test
    public void testValidateStorageTypesForResourceType() {
        CfnInvalidRequestException cfnInvalidRequestException = assertThrows(CfnInvalidRequestException.class, () ->
                BaseHandlerStd.validateStorageTypesForResourceType(CHAT_TRANSCRIPTS, KINESIS_FIREHOSE, S3));
        assertThat(INVALID_PARAMETER_FOR_RESOURCE_TYPE_CHAT_TRANSCRIPTS).isEqualTo(cfnInvalidRequestException.getMessage());
    }

    @Test
    public void testRequireNullForType() {
        CfnInvalidRequestException cfnInvalidRequestException = assertThrows(CfnInvalidRequestException.class, () ->
                BaseHandlerStd.requireNullForStorageType(InstanceStorageConfig.builder().build(), KINESIS_VIDEO_STREAM_CONFIG, S3));
        assertThat(INVALID_PARAMETER_FOR_STORAGE_TYPE_S3).isEqualTo(cfnInvalidRequestException.getMessage());
    }
}
